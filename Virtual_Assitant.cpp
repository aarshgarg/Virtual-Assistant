...
void wishme(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Prof"<<endl;
        string phrase = "Good Morning Prof";
...
int main()
{
    ...
    cout<<"\t\t\t<============================================= MY NAME IS Aarsh Siri  ==========================================>"<<endl;
        ...
        if(strcmp(password, "lehri")==0){
            ...
            do{
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"I'm a virtual assistant created by my proficient  master Lehri sabb!!!"<<endl;
                    string phrase = "I am a virtual assistant created by my master Lehri sabb";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
        ...
        else
                {
                    ...
                    cout << "\t\t\t<============================= MY NAME IS Aarsh Lehri =============================>" << endl;
